 ...
 */
export async function runDirectTask(command: RunDirectTaskCommand) {
 ...
 */
export async function runSkillTask(command: RunSkillCommand) {
 ...
 */
export async function resumeExistingTask(command: ResumeTaskCommand) {
 ...
 */
export async function getTaskStatus(command: GetTaskStatusCommand) {
